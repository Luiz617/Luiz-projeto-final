...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="Avatar de Luiz" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou Luiz Paulo</p>
        <h1>Eu sou técnico em administração</h1>
        <p>Sou formado em administração, atleta e estudante. Estou cursando o segundo ano do ensino médio e minhas habilidades profissionais são /p>
        ...
        <div>
            ...
            <p class="badge bg-secondary">Boa organização do tempo</p>
        </div>
    </header>
